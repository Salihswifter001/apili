        ...
        <div class="data-container">
            <div class="data-header">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="Parça ara...">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $track->bpm; ?></td>
                            <td><?php echo $track->key; ?></td>
                            <td><?php echo $track->share_count; ?></td>
                            <td><?php echo $track->download_count; ?></td>
                            <td><?php echo date('d.m.Y H:i', strtotime($track->created_at)); ?></td>
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo URLROOT; ?>/music/track/<?php echo $track->id; ?>" class="btn-sm btn-info" title="Görüntüle" target="_blank">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo URLROOT; ?>/admin/editTrack/<?php echo $track->id; ?>" class="btn-sm btn-primary" title="Düzenle">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?php echo URLROOT; ?>/admin/deleteTrack/<?php echo $track->id; ?>" class="btn-sm btn-danger" title="Sil" onclick="return confirm('Bu parçayı silmek istediğinizden emin misiniz?');">
            ...
            <?php if(empty($data['tracks'])) : ?>
                <div class="no-data">
                    ...
                    <p>Henüz hiç parça bulunmuyor.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
