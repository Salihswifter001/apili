...
<div class="admin-container">
    ...
    <div class="admin-content">
        <h1>Çalma Listesi Yönetimi</h1>
        
        <?php flash('admin_message'); ?>
        
        <div class="data-container">
            <div class="data-header">
                <h3>Çalma Listesi Listesi</h3>
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="Çalma listesi ara...">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(strlen($playlist->description) > 50) : ?>
                                    <?php echo substr($playlist->description, 0, 50) . '...'; ?>
                                <?php else : ?>
                                    <?php echo $playlist->description; ?>
                                <?php endif; ?>
                            </td>
                            <td><?php echo $playlist->username; ?></td>
                            <td><?php echo $playlist->track_count; ?></td>
                            <td><?php echo date('d.m.Y H:i', strtotime($playlist->created_at)); ?></td>
                            <td>
                                <div class="action-buttons">
                                    <a href="<?php echo URLROOT; ?>/admin/editPlaylist/<?php echo $playlist->id; ?>" class="btn-sm btn-primary" title="Düzenle">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?php echo URLROOT; ?>/admin/deletePlaylist/<?php echo $playlist->id; ?>" class="btn-sm btn-danger" title="Sil" onclick="return confirm('Bu çalma listesini silmek istediğinizden emin misiniz?');">
            ...
            <?php if(empty($data['playlists'])) : ?>
                <div class="no-data">
                    ...
                    <p>Henüz hiç çalma listesi bulunmuyor.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
