...
class MusicModel {
    ...
    /**
     * Belirli bir genre/türdeki parçaları getir
     * 
     * @param int $userId Kullanıcı ID
     * @param string $genre Müzik türü
     * @return array Parça listesi
     */
    ...
    // Kullanıcının parçalarını sayfalama ve filtreleme ile getir
    public function getUserTracksWithPagination($userId, $limit = 12, $offset = 0, $genre = null, $sortBy = 'newest') {
        // Temel sorgu
    ...
    // Kullanıcının parça sayısını tür filtresine göre getir
    public function countUserTracks($userId, $genre = null) {
        $query = 'SELECT COUNT(*) as count FROM tracks WHERE user_id = :user_id';
